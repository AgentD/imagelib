...
/*
    ...
    What should work('-' means implemented,
      ...
      x Flipping images upside-down while loading if needed to move the origin
...
namespace
{
    ...
    void loadBMPbitfields( std::istream& src, size_t w, size_t h,
                           void* ptr, size_t bpp,
    ...
    void loadBMPcolormap( std::istream& src, size_t w, size_t h, void* ptr,
    ...
    void loadBMPrle( std::istream& src, size_t w, size_t h, void* ptr,
...
CImage::E_LOAD_RESULT CImage::m_loadBmp( std::istream& file )
{
    ...
    allocateBuffer( biWidth, biHeight, 1, EIT_RGB8 );
